...
List<Alignment> cardsAlign = [ new Alignment(0.0, 0.0), new Alignment(0.0, 0.8), new Alignment(0.0, 1.0) ];
...
class CardsSectionAlignment extends StatefulWidget
{
  ...
  {
    cardsSize[0] = new Size(MediaQuery.of(context).size.width * 0.8, MediaQuery.of(context).size.height * 0.5);
    cardsSize[1] = new Size(MediaQuery.of(context).size.width * 0.85, MediaQuery.of(context).size.height * 0.55);
    cardsSize[2] = new Size(MediaQuery.of(context).size.width * 0.9, MediaQuery.of(context).size.height * 0.6);
  }
